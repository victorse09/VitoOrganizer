...
class CodeEditorWidget(QWidget):
    ...
    def __init__(self, item_calc: dict, project_item: dict, agenda_path: str, parent=None):
        ...
        self.storage_dir = os.path.join(self.agenda_path, 'retro', 'desarrollo', safe_name, self.calc_id)
...
class PaintEditorWidget(QWidget):
    ...
    def _import_image(self):
        path, _ = QFileDialog.getOpenFileName(self, "Cargar Imagen", "", IMAGE_FILE_FILTER)
        if path:
...
class SchematicEditorWidget(QFrame):
    ...
    def _get_storage_dir(self) -> str:
        ...
        folder_path = os.path.join(self.agenda_path, 'retro', 'desarrollo', safe_name, calc_id)
